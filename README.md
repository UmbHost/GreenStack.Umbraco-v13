# GreenStack.Umbraco-v13

A GitHub template repository for Umbraco 13 (LTS) preconfigured for [GreenStack](https://umbhost.net/sustainable-cloud-hosting/modern-umbraco-hosting) hosting.
